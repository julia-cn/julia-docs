...
about the proper (and improper) uses of `Val`, please read the more extensive discussion in [the performance tips](https://docs.julialang.org/en/v1.0/manual/performance-tips/#man-performance-tips-1).

> [[1]](https://docs.julialang.org/en/v1.0/manual/types/#footnote-1)
