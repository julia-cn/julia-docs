...
> [[1]](https://docs.julialang.org/en/v1.0/manual/methods/#footnote-1)
...
they can be used anywhere a value would be in the signature of the function or body of the function. Here's an example where the method type parameter `T` is used as the type parameter to the parametric type `Vector{T}` in the method signature:
...
> [[Clarke61]](https://docs.julialang.org/en/v1.0/manual/methods/#footnote-Clarke61)
